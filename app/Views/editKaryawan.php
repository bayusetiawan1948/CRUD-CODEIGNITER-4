  ...
  <div class="container">
    <div class="row">
      <div class="col-9 m-5">
        ...
        <form action="<?= base_url('/update/' . $data['nik']) ?>" method="post">
          <?= csrf_field(); ?>
          <div class="card mt-3" style="width: 32rem;">
            <div class="card-body">
              <div class="mb-3">
                <label for="nik" class="form-label">NIK Karyawan</label>
                <input type="text" class="form-control" id="nik" placeholder="Masukan NIK karyawan" name="nik" value="<?= $data['nik'] ?>">
              </div>
              <div class="mb-3">
                <label for="nama" class="form-label">Nama Karyawan</label>
                <input type="text" class="form-control" id="nama" placeholder="Masukan nama karyawan" name="nama" value="<?= $data['nama'] ?>">
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="date" class="form-control" id="tgl-lahir" placeholder="Masukan tanggal lahir karyawan" name="tgl_lahir" value="<?= $data['tgl_lahir'] ?>">
              </div>
              <div class="mb-3">
                <label for="alamat" class="form-label">Alamat Karyawan</label>
                <textarea class="form-control" id="alamat" rows="3" placeholder="Alamt Karyawan" name="alamat"><?= $data['alamat'] ?></textarea>
              </div>
            </div>
